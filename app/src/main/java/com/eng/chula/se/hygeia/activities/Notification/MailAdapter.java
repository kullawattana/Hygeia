...
public class MailAdapter extends RecyclerView.Adapter<MailViewHolder> {
    ...
    public MailViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_notification_item, parent, false);
        ...
        holder.mFavorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (holder.mFavorite.getColorFilter() != null) {
                    ...
                    holder.mFavorite.setColorFilter(ContextCompat.getColor(mContext, R.color.colorOrange));
                }
            }
        });
