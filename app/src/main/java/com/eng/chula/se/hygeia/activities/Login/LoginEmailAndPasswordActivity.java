...
public class LoginEmailAndPasswordActivity extends BaseActivity implements View.OnClickListener {
	private static final String TAG = "LoginEmailAndPasswordActivity";
				...
				firebaseUser.sendEmailVerification().addOnCompleteListener(this, new OnCompleteListener<Void>() {
					...
					public void onComplete(@NonNull Task<Void> task) {
						if (task.isSuccessful()) {
							Toast.makeText(
									LoginEmailAndPasswordActivity.this, "Verification email sent to " + firebaseUser.getEmail(), Toast.LENGTH_LONG
							).show();
						} else {
							Toast.makeText(LoginEmailAndPasswordActivity.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
						}
