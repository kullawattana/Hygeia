...
import com.eng.chula.se.hygeia.activities.Chat.Model.Message;
import com.eng.chula.se.hygeia.activities.Chat.Model.User;
import com.eng.chula.se.hygeia.activities.Chat.ViewHolder.ViewHolderChat;
...
public class ChatRoomActivity extends DefaultActivity {
    ...
    private void loadProfilePicture(byte [] pictureBytes, ImageView imageView){
        Glide.with(this).load(pictureBytes)
                .fallback(R.drawable.chat_icon_resize)
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK){
            ...
            alertDialog.setIcon(R.drawable.chat_icon_resize).setTitle("Do you really want to leave ?")
